...
class Stat(GameObject):
    def __init__(self, name='undefined', type='skill', stat='int', lvl=0, ip=0, diff=1, chip=False, frequency=0, importance=0, intensity=0):
        super().__init__()
        ...
        if type=='skill':
            ...
            self.set_attribute('intensity', intensity)
